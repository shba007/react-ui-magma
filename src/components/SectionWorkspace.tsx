...
export default function SectionWorkspace({ gsap, type, frameCount }: { gsap: typeof g; type: string; frameCount: number }) {
  ...
  return (
    <section id={type} ref={containerRef} className="h-screen bg-[#183bd6]">
      <canvas ref={canvasRef} className="relative max-h-[100vh] max-w-[100vw]" />
    </section>
  )
}
